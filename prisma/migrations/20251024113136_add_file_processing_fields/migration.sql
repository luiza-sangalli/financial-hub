...
ALTER TABLE "files" ADD COLUMN "failedRows" INTEGER;
ALTER TABLE "files" ADD COLUMN "processedAt" DATETIME;
ALTER TABLE "files" ADD COLUMN "processedRows" INTEGER;
ALTER TABLE "files" ADD COLUMN "successfulRows" INTEGER;
...
INSERT INTO "new_transactions" ("amount", "categoryId", "companyId", "createdAt", "createdById", "date", "description", "id", "type", "updatedAt", "updatedById") SELECT "amount", "categoryId", "companyId", "createdAt", "createdById", "date", "description", "id", "type", "updatedAt", "updatedById" FROM "transactions";
